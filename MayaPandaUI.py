...
def MP_PY_ExportOptionsUI():
    ...
    if selected_rb == "MP_PY_ChooseActorRB":
        ...
        pm.intField("MP_PY_AnimationStartFrameIF", edit = True, enable = False, value = 0)
        pm.intScrollBar("MP_PY_AnimationStartFrameSlider", edit = True, enable = False, value = 0)
        pm.intField("MP_PY_AnimationEndFrameIF", edit = True, enable = False, value = 48)
        pm.intScrollBar("MP_PY_AnimationEndFrameSlider", edit = True, enable = False, value = 48)
        pm.radioButton("MP_PY_chooseFullAnimationRangeRB", edit = True, enable = False, select = True)
        pm.radioButton("MP_PY_chooseCustomAnimationRangeRB", edit = True, enable = False)
        pm.text("MP_PY_CharacterNameLabel", edit = True, enable = True)
        pm.textField("MP_PY_CharacterNameTF", edit = True, enable = True)
        pm.text("MP_PY_ForceJointLabel", edit = True, enable = True)
        pm.textField("MP_PY_ForceJointTF", edit = True, enable = True)
        pm.radioButton("MP_PY_ChooseTransformModelRB", edit = True, select = True)
        pm.checkBox("MP_PY_ExportLightsCB", edit = True, enable = False, value = False)
        pm.checkBox("MP_PY_ExportCamerasCB", edit = True, enable = False, value = False)
        ...
        pm.intField("MP_PY_AnimationEndFrameIF", edit = True, enable = False, value = 48)
        pm.intScrollBar("MP_PY_AnimationEndFrameSlider", edit = True, enable = False, value = 48)
        pm.radioButton("MP_PY_chooseFullAnimationRangeRB", edit = True, enable = True, select = True)
        pm.radioButton("MP_PY_chooseCustomAnimationRangeRB", edit = True, enable = True)
        pm.text("MP_PY_CharacterNameLabel", edit = True, enable = True)
        pm.textField("MP_PY_CharacterNameTF", edit = True, enable = True)
        pm.text("MP_PY_ForceJointLabel", edit = True, enable = True)
        pm.textField("MP_PY_ForceJointTF", edit = True, enable = True)
        ...
        pm.radioButton("MP_PY_chooseFullAnimationRangeRB", edit = True, enable = False, select = True)
        pm.radioButton("MP_PY_chooseCustomAnimationRangeRB", edit = True, enable = False)
        pm.text("MP_PY_CharacterNameLabel", edit = True, enable = False)
        pm.textField("MP_PY_CharacterNameTF", edit = True, enable = False, text = "")
        pm.text("MP_PY_ForceJointLabel", edit = True, enable = False)
        pm.textField("MP_PY_ForceJointTF", edit = True, enable = False, text = "")
        pm.radioButton("MP_PY_ChooseTransformModelRB", edit = True, select = True)
        pm.checkBox("MP_PY_ExportLightsCB", edit = True, enable = True)
        pm.checkBox("MP_PY_ExportCamerasCB", edit = True, enable = True)
        pm.checkBox("MP_PY_RemoveGroundPlaneCB", edit = True, enable = True, value = True)
        MP_PY_AnimationOptionsUI("animationMode", "")
        MP_PY_AnimationOptionsUI("updateFrameValues", "updateAllValues")

    elif selected_rb == "MP_PY_ChoosePoseRB":
        print("Export Selected Actor Animation Pose")
        pm.intField("MP_PY_AnimationStartFrameIF", edit = True, enable = True, value = 0)
        pm.intScrollBar("MP_PY_AnimationStartFrameSlider", edit = True, enable = True, value = 0)
        pm.intField("MP_PY_AnimationEndFrameIF", edit = True, enable = False, value = 48)
        pm.intScrollBar("MP_PY_AnimationEndFrameSlider", edit = True, enable = False, value = 48)
        pm.radioButton("MP_PY_chooseFullAnimationRangeRB", edit = True, enable = False)
        pm.radioButton("MP_PY_chooseCustomAnimationRangeRB", edit = True, enable = True, select = True)
        pm.text("MP_PY_CharacterNameLabel", edit = True, enable = True)
        pm.textField("MP_PY_CharacterNameTF", edit = True, enable = True)
        pm.text("MP_PY_ForceJointLabel", edit = True, enable = True)
        pm.textField("MP_PY_ForceJointTF", edit = True, enable = True)
